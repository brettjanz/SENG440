...
all:
	...
	(sleep 1; echo user1; sleep 1; echo q6coHjd7P; sleep 1; echo ./brettliam/main.exe brettliam/test.wav brettliam/decompressed.wav; sleep 5; echo ./brettliam/main_optimized.exe brettliam/test.wav brettliam/opt_decompressed.wav; sleep 5; echo diff -s ./brettliam/decompressed.wav ./brettliam/opt_decompressed.wav; sleep 30;) | telnet arm
